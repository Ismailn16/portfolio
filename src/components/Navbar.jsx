...
const Navbar = () => {
    ...
    return (
        <div className='z-10 text-white flex justify-between items-center h-24 px-4 max-w-[1240px] mx-auto text-l'>
            ...
            <motion.h1 variants={container(0.3)} initial='hidden' animate='visible' className='text-3xl font-bold primary-color ml-4'>Abdul Noor</motion.h1>
            <motion.ul variants={container(0.3)} initial='hidden' animate='visible' className='hidden md:flex'>
