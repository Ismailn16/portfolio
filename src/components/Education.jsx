                ...
                <div className="flex flex-wrap">
                    <div className="w-full">
                        <div className="skill-bx wow zoomIn text-center">
                            <motion.h3 whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -50 }} transition={{ duration: 0.8, delay: 2 }} className="text-3xl font-semibold mb-4"><span className='primary-color'>Education</span></motion.h3>
                            <motion.p whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -50 }} transition={{ duration: 0.8, delay: 2 }} className="mb-8 text-white">
                                The following key modules have significantly contributed to my development during my studies at UWE Bristol.
                            </motion.p>
                            <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: -50 }} transition={{ duration: 1, delay: 2 }}>
