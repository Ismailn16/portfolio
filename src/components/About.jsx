...
const About = () => {
    return (
        <div id='About' className='py-10 text-white h-auto'>
            <div className='flex sm:flex-row flex-col-reverse items-center md:gap-6 gap-12 px-10 max-w-6xl mx-auto'>

                <div>
                    <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ x: -100, opacity: 0 }} transition={{ duration: 0.8, delay: 2 }} className='w-[400px] h-full'>
                        <img src={aboutImg}
                            alt=''
                ...
                <div>
                    <div className='p-2'>
                        <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ x: 100, opacity: 0 }} transition={{ duration: 0.8, delay: 2 }} className='text-white my-2'>
